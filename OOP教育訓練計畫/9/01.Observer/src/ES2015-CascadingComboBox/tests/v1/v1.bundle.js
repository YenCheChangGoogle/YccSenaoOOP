...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__v1_CascadingComboBox__ = __webpack_require__(10);


let comboBox3 = new __WEBPACK_IMPORTED_MODULE_0__v1_CascadingComboBox__["a" /* CascadingComboBox */]('category3');
let comboBox2 = new __WEBPACK_IMPORTED_MODULE_0__v1_CascadingComboBox__["a" /* CascadingComboBox */]('category2', comboBox3);
let comboBox1 = new __WEBPACK_IMPORTED_MODULE_0__v1_CascadingComboBox__["a" /* CascadingComboBox */]('category1', comboBox2);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__SystemUtils__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_assert_js__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_assert_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_assert_js__);
...
class CascadingComboBox {
    ...
    constructor(id, child = null) {
        ...
        __WEBPACK_IMPORTED_MODULE_1_assert_js___default.a.true(__WEBPACK_IMPORTED_MODULE_0__SystemUtils__["c" /* isNotNull */](this.domObject), `HTML 元素 ${id} 不存在!`);
        this.child = child;
        this.data = [];
        this.defaultOptions = [];
    ...
    bindEvents() {
        ...
        this.domObject.onchange = () => {
            if (__WEBPACK_IMPORTED_MODULE_0__SystemUtils__["c" /* isNotNull */](this.onItemSelected)) {
                // 將選取的項目編號傳給使用者指定的 callback
                this.onItemSelected(this, this.domObject.selectedIndex);
            }

            if (__WEBPACK_IMPORTED_MODULE_0__SystemUtils__["d" /* isNull */](this.child)) { return; }
    ...
    fillOptions() {
        ...
        // 如果有子選單而且有預設值
        if (__WEBPACK_IMPORTED_MODULE_0__SystemUtils__["c" /* isNotNull */](this.child) && this.domObject.selectedIndex > 0) {
            this.updateChild();
        }
    }
    ...
    createOptions(element, index) {
        if (__WEBPACK_IMPORTED_MODULE_0__SystemUtils__["d" /* isNull */](this.onCreateOption)) { return; }
        ...
        // 有預設選項嗎?
        if (__WEBPACK_IMPORTED_MODULE_0__SystemUtils__["a" /* isEmpty */](this.defaultOptions)) { return; }
    ...
    clear() {
        ...
        if (__WEBPACK_IMPORTED_MODULE_0__SystemUtils__["c" /* isNotNull */](this.child)) {
            this.child.clear();
        }
    }
     ...
     */
    updateChild() {
        if (__WEBPACK_IMPORTED_MODULE_0__SystemUtils__["d" /* isNull */](this.onCreateChildData)) {
            return;
        }
