...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__v3_CascadingComboBox__ = __webpack_require__(16);


let mainCombobox = new __WEBPACK_IMPORTED_MODULE_0__v3_CascadingComboBox__["a" /* CascadingComboBox */]({
    id: 'categoryMain',
...
let combobox1 = new __WEBPACK_IMPORTED_MODULE_0__v3_CascadingComboBox__["a" /* CascadingComboBox */]({
    id: 'category1',
    onCreateOption: onCreateOptionCallback,
    onSelected: onItemSelectedCallback
});
...
let combobox2 = new __WEBPACK_IMPORTED_MODULE_0__v3_CascadingComboBox__["a" /* CascadingComboBox */]({
    id: 'category2',
    onCreateOption: onCreateOptionCallback,
    onSelected: onItemSelectedCallback
});
...
let combobox3 = new __WEBPACK_IMPORTED_MODULE_0__v3_CascadingComboBox__["a" /* CascadingComboBox */]({
    id: 'category3',
    onCreateOption: onCreateOptionCallback,
    onSelected: onItemSelectedCallback
});
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__SystemUtils__ = __webpack_require__(17);
...
class CascadingComboBox {
    ...
    constructor(options) {
        ...
        __WEBPACK_IMPORTED_MODULE_1_assert_js___default.a.true(__WEBPACK_IMPORTED_MODULE_0__SystemUtils__["c" /* isNotNull */](this.domObject), `HTML 元素 ${this.id} 不存在!`);
        this.children = [];
        this.data = [];
        this.defaultOptions = [];
